...
namespace QA.DotNetCore.Caching.Distributed
{
    public class ExternalCacheKeyFactory : CacheKeyFactoryBase
    {
        ...
        internal CacheKey CreateKey(string key) => new(CacheKeyType.Key, key, _settings.AppName, _settings.InstanceName);

        internal CacheKey CreateTag(string tag) => new(CacheKeyType.Tag, tag, _settings.AppName, _settings.InstanceName);

        internal CacheKey CreateLock(string key) => new(CacheKeyType.Lock, key, _settings.AppName, _settings.InstanceName);
