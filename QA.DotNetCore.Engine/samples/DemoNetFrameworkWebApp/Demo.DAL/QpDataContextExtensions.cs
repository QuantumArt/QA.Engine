...
namespace Demo.DAL
{
    public partial class QpDataContext: IQPLibraryService, IQPFormService, IQPSchema
    {
        ...
        public QpDataContext(DbCompiledModel model, ModelReader schema) : base(model)
        {
        ...
        public QpDataContext(DbConnection connection, DbCompiledModel model, ModelReader schema, bool contextOwnsConnection)
		...
		public static QpDataContext Create(IMappingConfigurator configurator, SqlConnection connection, bool contextOwnsConnection)
        {
            ...
            var ctx = new QpDataContext(connection, mapping.DbCompiledModel, mapping.Schema, contextOwnsConnection);
        ...
        public static QpDataContext CreateWithStaticMapping(ContentAccess contentAccess, SqlConnection connection, bool contextOwnsConnection)
        {
		  ...
		  public static QpDataContext CreateWithDatabaseMapping(ContentAccess contentAccess)
        {         
        ...
        public static QpDataContext CreateWithDatabaseMapping(ContentAccess contentAccess, string siteName, SqlConnection connection, bool contextOwnsConnection)
        {
        ...
        public static QpDataContext CreateWithFileMapping(ContentAccess contentAccess, string path, SqlConnection connection, bool contextOwnsConnection)
        {
