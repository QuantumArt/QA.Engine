...
namespace WebApplication1.Routing
{
    public class ContentRoute : Route
    {
        ...
        public ContentRoute(AbstractItemStorage storage, IRouter target, string routeTemplate, IInlineConstraintResolver inlineConstraintResolver)
            : this(storage, target, routeTemplate, null, null, null, inlineConstraintResolver)
        {
        }

        public ContentRoute(AbstractItemStorage storage, IRouter target, string routeTemplate, RouteValueDictionary defaults, IDictionary<string, object> constraints, RouteValueDictionary dataTokens, IInlineConstraintResolver inlineConstraintResolver)
            : this(storage, target, null, routeTemplate, defaults, constraints, dataTokens, inlineConstraintResolver)
        {
        }

        public ContentRoute(AbstractItemStorage storage, IRouter target, string routeName, string routeTemplate, RouteValueDictionary defaults, IDictionary<string, object> constraints, RouteValueDictionary dataTokens, IInlineConstraintResolver inlineConstraintResolver)
